                ...
                <div class="col-lg-12">
                    <div class="slider-content">
                        <div class="heading" >
                            ...
                            <p class="subtitle-maffia text-white body-1 wow fadeIn hide-mobile" data-wow-delay=".8s" data-wow-duration="2000ms">Contamos con más de 1000 propiedades ideales para vos.</p>
                        </div>
                        <div class="flat-tab flat-tab-form">
                            <ul class="nav-tab-form style-1 ml-10" role="tablist">
                                <li class="nav-tab-item" role="presentation">   
                                    <a href="#forRent" class="nav-link-item active"  data-bs-toggle="tab">Comprar</a>
                                </li>
                                <li class="nav-tab-item" role="presentation">
                                    <a href="#forSale" class="nav-link-item" data-bs-toggle="tab">Alquilar</a>
                                </li>
                                <li class="nav-tab-item hide-mobile" role="presentation">
                                    <a href="#forSale" class="nav-link-item" data-bs-toggle="tab">Alquiler Temporal</a>
                                </li>
                            </ul>
                                            ...
                                            <div class="wd-find-select">
                                                <div class="inner-group">
                                                    ...
                                                    <div class="form-group-2 form-style">
                                                        ...
                                                        <div class="group-ip">
                                                            <input id="locationVenta" type="text" class="form-control" placeholder="ingresá una localidad" value="" name="search" title="Search for">
                                                        </div>
                                                    </div>
                                                </div>
                    ...
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <a href="" class="box-location">
                                <div class="image">
                                    <img src="https://d1v2p1s05qqabi.cloudfront.net/sites/320/media/1686086632151.webp?v=9" alt="image-location">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <a href="" class="box-location">
                                <div class="image">
                                    <img src="https://d1v2p1s05qqabi.cloudfront.net/3150815/24078477004709880812079334202526294131554997236344912071511030567294450968536.jpg" alt="image-location">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <a href="" class="box-location">
                                <div class="image">
                                    <img src="https://static.tokkobroker.com/water_pics/65602795529075104354202997649107471741351481886641144111574864647161883522146.jpg" alt="image-location">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <a href="" class="box-location">
                                <div class="image">
                                    <img src="https://imgar.zonapropcdn.com/avisos/1/00/51/97/16/10/1200x1200/1882560757.jpg?isFirstImage=true" alt="image-location">
                                </div>
                                <div class="content">
                        ...
                        <div class="swiper-slide">
                            <a href="" class="box-location">
                                <div class="image">
                                    <img src="https://d1v2p1s05qqabi.cloudfront.net/785529/60512183022162341592970052656507607783660910529578735180869439696105606860245.jpg" alt="image-location">
                                </div>
                                <div class="content">
            ...
            <div class="wrap-property">
                <div class="box-left  wow fadeInLeftSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                    <div class="homeya-box lg">
                        <div class="archive-top">
                            ...
                            <div class="content">
                                <h5 class="fw-3"><a href="ficha.html" class="link"> Alquiler temporal La Delfina - Pilar - Frente al Hospital Austral</a></h5>
                                <div class="desc"><i class="icon icon-mapPin"></i><p>Avenida Rolón 3400, Lomas de San Isidro, San Isidro</p> </div>
                ...
                <div class="box-right wow fadeInRightSmall" data-wow-delay=".2s" data-wow-duration="2000ms">
                    <div class="homeya-box list-style-1">
                        ...
                        <div class="content">
                            <div class="archive-top">
                                <div class="h7 text-capitalize fw-3"><a href="ficha.html" class="link">Alquiler temporal La Delfina - </a></div>
                                <div class="desc">
                    ...
                    <div class="homeya-box list-style-1">
                        <a href="ficha.html" class="images-group">
                            <div class="images-style">
                                <img src="https://static.tokkobroker.com/w_pics/6163943_101500208500650703435093299336957320059296155478694986738925915755017055932419.jpg" alt="img">
                            </div>
                            
                        </a>
                        <div class="content">
                            <div class="archive-top">
                                <div class="h7 text-capitalize fw-3"><a href="ficha.html" class="link">Alquiler temporal La Delfina - Pilar...</a></div>
                    ...
                    <div class="homeya-box list-style-1">
                        <a href="property-details-v1.html" class="images-group">
                            <div class="images-style">
                                <img src="https://static.tokkobroker.com/water_pics/13189665647666139169816260051114795360087888557017275650103167469248947913944.jpg" alt="img">
                            </div>
                            
                        </a>
                        <div class="content">
                            <div class="archive-top">
                                <div class="h7 text-capitalize fw-3"><a href="ficha.html" class="link">Casa en Venta en Pilar</a></div>
                                <div class="desc"><i class="icon icon-mapPin"></i><p>Avenida Ricarod Garay 1200, Pilar</p> 
                                </div>
                                <ul class="meta-list">
                                    <li class="item">
                                        <i class="icon icon-bed"></i>
...
<script>
    ...
    $('#locationVenta').typeahead({
        ...
        $('#locationid-input-venta').val(suggestion.location_id);
        $('#locationname-input-venta').val(suggestion.location_name != undefined ? suggestion.location_name :
            suggestion.development_name);
        $('#operationtype-input-venta').val(suggestion.location_name != undefined ? 'venta' : 'emprendimiento');
    });
