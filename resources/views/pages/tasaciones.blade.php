...
@section('content')
    ...
    <section class="flat-title-page style-2">
        <div class="container">
            ...
            <h2 class="text-center">Tasá hoy tu propiedad</h2>
        </div>
    </section>
    <!-- End Page Title -->
            ...
            <div class="row">
                <div class="col-lg-8">
                    <div class="contact-content">
                        <h5>Tasá tu propiedad</h5>
                        <p class="body-2 text-variant-1">Conocé el verdadero valor de tu propiedad. Tasá con profesionales.</p>
                        <form id="contactform" method="post" action="./contact/contact-process.php" class="form-contact">
                            ...
                            <div class="box grid-2">
                                ...
                                <fieldset>
                                    ...
                                    <div class="group-select">
                                        <div class="nice-select" tabindex="0"><span class="current">Qué tipo de propiedad tenés</span>
                                            <ul class="list">  
                                                                                                      
                                                <li data-value="villa" class="option">Casa/Ph</li>
                                                <li data-value="studio" class="option">Departamento</li>
                                                <li data-value="office" class="option">Lote</li>
                                                <li data-value="house" class="option">Oficina </li>
                                                <li data-value="house" class="option">Local comercial</li>
                            ...
                            <div class="send-wrap">
                                <button class="tf-btn primary size-1" type="submit">Enviar</button>
                            </div>
                        </form>
                    </div>
                </div>
                <div class="col-lg-4">
                    <div class="contact-info">
                        <h5>Tomá contacto con nosotros.</h5>
                        <ul>
                            <li class="box">
